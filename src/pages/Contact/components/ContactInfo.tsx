...
const ContactInfo = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center gap-5'>
      <div className='inline-flex gap-1 justify-center mb-10'>
        <h4 className='text-center text-3xl text-secondary tracking-wide'>
          connect with me
        </h4>
        <PiSparkleFill className='text-accent-pink text-xl' />
      </div>

      <div className='group flex items-center justify-center gap-5 text-[#99d6ea]'>
        <FontAwesomeIcon
          icon={faEnvelope}
          size='lg'
          className='group-hover:text-accent-pink transition-colors'
        />
        <h5 className='tracking-wide text-lg sm:text-xl group-hover:text-accent-pink transition-colors'>
